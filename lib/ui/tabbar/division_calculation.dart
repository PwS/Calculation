...
class DivisionCalculationPages extends StatefulWidget {
  @override
  _DivisionCalculationPagesState createState() =>
      _DivisionCalculationPagesState();
}

class _DivisionCalculationPagesState extends State<DivisionCalculationPages> {
  int valueA;
  int valueB;
  int result;
  ...
  Widget buttonCalculate() {
    return RaisedButton(
      ...
      child: Container(
        ...
        child: Text('Calculate Divide', style: TextStyle(fontSize: 20)),
      ),
    );
  }
