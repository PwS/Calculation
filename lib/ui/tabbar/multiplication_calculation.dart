...
class MultiplicationCalculationPages extends StatefulWidget {
  @override
  _MultiplicationCalculationPagesState createState() =>
      _MultiplicationCalculationPagesState();
}

class _MultiplicationCalculationPagesState
    extends State<MultiplicationCalculationPages> {
  int valueA;
  int valueB;
  int result;
  ...
  Widget buttonCalculate() {
    return RaisedButton(
      ...
      child: Container(
        ...
        child: Text('Calculate Multiplication', style: TextStyle(fontSize: 20)),
      ),
    );
  }
